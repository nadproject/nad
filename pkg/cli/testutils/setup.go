...
func Setup1(t *testing.T, db *database.DB) {
	...
	database.MustExec(t, "setting up book 1", db, "INSERT INTO books (uuid, name) VALUES (?, ?)", b1UUID, "js")
	database.MustExec(t, "setting up book 2", db, "INSERT INTO books (uuid, name) VALUES (?, ?)", b2UUID, "linux")
...
func Setup2(t *testing.T, db *database.DB) {
	...
	database.MustExec(t, "setting up book 1", db, "INSERT INTO books (uuid, name, usn) VALUES (?, ?, ?)", b1UUID, "js", 111)
	database.MustExec(t, "setting up book 2", db, "INSERT INTO books (uuid, name, usn) VALUES (?, ?, ?)", b2UUID, "linux", 122)
